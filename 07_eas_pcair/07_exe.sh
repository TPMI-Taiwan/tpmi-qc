...
grep -vwf ../06_pca/pca.not_eas.id ../05_merge_qc/stage1_rmAffy_rmdup_mind005_geno002.fam > tpm1.eas.fam
...
plink2.4 --bfile tpm1.eas.geno002_maf001 --exclude ../HighLD_SNP.list --indep-order 2 --indep-pairwise 1000kb 0.2 --maf 0.05 --out ld
[[ $? -ne 0 ]] && exit
